...
func _process(delta):
	...
	if not visible:
		if global_position.distance_to(Driver.get_global_position()) > 2.1:
			$Shell/DaGoodBox.set_surface_override_material(0, lc_materials["godwhite"]["slwbase"])
			$Shell/DaGoodBox1U.set_surface_override_material(0, lc_materials["pink"]["slwbase"])
			$Shell/DaGoodBox1D.set_surface_override_material(0, lc_materials["pink"]["slwbase"])
			$Shell/DaGoodBox2U.set_surface_override_material(0, lc_materials["blue"]["slwbase"])
			$Shell/DaGoodBox2D.set_surface_override_material(0, lc_materials["blue"]["slwbase"])
			show()
	elif not hot:
		...
		if global_position.distance_to(Driver.get_global_position()) > 6:
			...
			$Shell/DaGoodBox.set_surface_override_material(0, lc_materials["godwhite"]["lwbase"])
			$Shell/DaGoodBox1U.set_surface_override_material(0, lc_materials["pink"]["lwbase"])
			$Shell/DaGoodBox1D.set_surface_override_material(0, lc_materials["pink"]["lwbase"])
			$Shell/DaGoodBox2U.set_surface_override_material(0, lc_materials["blue"]["lwbase"])
			$Shell/DaGoodBox2D.set_surface_override_material(0, lc_materials["blue"]["lwbase"])
